...
class _RiwayatState extends State<Riwayat> {
  ...
  Future _getdata() async {
    try {
      String url = "https://apkmonitoring.bantuas.online/getriwayat_data.php";
  ...
  Future<void> hitungAksi() async {
    for (var datalist in _listData) {
      ...
      //blower kurang
      List<double> ruleBlowerkurang = [r1, r3, r5, r9, r13, r15, r17];
      double blowerkurang = ruleBlowerkurang.reduce(
          (maxValue, current) => maxValue > current ? maxValue : current);
      //heater nyala
      List<double> ruleHeaterNyala = [r1, r2, r3, r4, r5, r6, r13, r14];
      ...
      double heaterMati = ruleHeaterMati.reduce(
          (maxValue, current) => maxValue > current ? maxValue : current);
      //cooling pad nyala
      List<double> ruleCPNyala = [r5, r6, r9, r10, r11, r12, r17, r18];
      double cpNyala = ruleCPNyala.reduce(
          (maxValue, current) => maxValue > current ? maxValue : current);
      //Cooling pad mati
      List<double> ruleCPMati = [r1, r2, r3, r4, r7, r8, r13, r14, r15, r16];
